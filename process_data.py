...
if __name__ == "__main__":
    ...
    # np.save("q_tokens.npy", np.array(q_tokens))
    # np.save("a_tokens.npy", np.array(a_tokens))
    q_tokens = np.load('q_tokens.npy')
    a_tokens = np.load('a_tokens.npy')
